 ...
 <aside class="sidebar" id="sidebar">
    ...
    <main class="main-content">
        <div class="page-header">
            <h1>المستخدمين <span>والطلبات</span></h1>
            <p>إدارة الطلاب وصاحب السكن</p>
        </div>

        <div class="stats-grid">
            <div class="stat-card"><div class="stat-number" id="totalStudents">0</div><div class="stat-label">إجمالي الطلاب</div></div>
            <div class="stat-card"><div class="stat-number" id="totalOwners">0</div><div class="stat-label">إجمالي المُلاك</div></div>
            <div class="stat-card"><div class="stat-number" id="totalBanned" style="color: var(--danger);">0</div><div class="stat-label">المحظورين</div></div>
        ...
        <div class="controls-bar">
            <div class="search-box">
                ...
                <input type="text" id="searchInput" placeholder="ابحث بالاسم أو البريد أو رقم الهاتف..." oninput="renderTable()">
            </div>
        ...
        <div class="table-container">
            <div class="table-header"><h3 id="tableTitle">👨‍🎓 قائمة الطلاب</h3></div>
    ...
    <div class="modal-overlay" id="detailsModal" onclick="closeModal(event)">
        <div class="modal-box" onclick="event.stopPropagation()">
            <div class="modal-header"><h3>تفاصيل المستخدم</h3><button class="modal-close" onclick="closeModal()">✕</button></div>
